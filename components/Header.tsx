        ...
        <div className="flex items-center gap-2 justify-center flex-1 min-w-0">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white/20 backdrop-blur text-white text-xs md:text-sm pl-7 min-[426px]:pl-4 pr-6 md:pr-8 py-1.5 md:py-2 rounded-lg border border-white/30 focus:outline-none focus:border-white/60 cursor-pointer hover:bg-white/30 transition-all max-[425px]:w-10"
            ...
            <svg className="absolute left-2 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-white/70 pointer-events-none max-[425px]:block hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
